...
export default class wT_ActivityExtensionLWC extends NavigationMixin(LightningElement) {
    ...
    @track showAnnualReviewLayout=false;
    @track showEditAnnualReviewLayout=false;
                    ...
                    if ((result != undefined && result != null)) {
                       ...
                       // this.displayEventLayout = true;
                        ...
                        fetchRecordTypeID({ recordTypeName: this.eventRecordTypeName })
                            ...
                            if (this.eventRecordTypeName == 'WT_Annual_Review') {
                                this.showAnnualReviewLayout=true;
                                this.showEditAnnualReviewLayout=false;
                            }
                            else if(this.eventRecordTypeName == 'WT_Wintrust_Event' || this.eventRecordTypeName == 'WT_Event' || this.eventRecordTypeName == 'WT_CRA_Event'){
                                this.showEditEventDetail = false;
                                this.displayEventLayout = true;
    ...
    handleAnnualReviewEditEvent(event) {
        this.showEditAnnualReviewLayout = true;
    }
