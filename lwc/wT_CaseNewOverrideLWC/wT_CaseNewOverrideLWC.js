...
export default class wT_CaseNewOverrideLWC extends NavigationMixin(LightningElement) {    
    ...
    @track showMyHRCasesLayout=false;
    @track loaded= false;
    connectedCallback() {
        ...
        if(createdRecord !='')
        {
            ...
            .then(result => {
                ...
                setTimeout(() => {
                    ...
                    this.showDepositApplicationLayout= false;
                    this.showCCPALayout= false;
                    this.showMyHRCasesLayout= false;
                    this.recordTypeId= '';
                    this.loaded= true;
                    this.template.querySelector("c-w-t-compliance-case-override").stopSpinnerAfterSaveSuccess();
                    this.template.querySelector("c-w-t-my-h-r-cases-l-w-c").stopSpinnerAfterSaveSuccess();
                }, 3000);
              })
                .catch(error => {
