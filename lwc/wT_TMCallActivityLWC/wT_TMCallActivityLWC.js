...
export default class WT_TMCallActivityLWC extends NavigationMixin(LightningElement) {
    ...
    @track showWFGEditlayout = false;
    @track showWFGViewlayout = false;
    ...
    @track showReadOnlyWFGSection = false;
        ...
        connectedCallback() {
            ...
            .then(result => {
                ...
                if((this.activityExtId != undefined || this.activityExtId != null) && this.taskRecordTypeName == 'TM_Call')
                {
               ...
               if((this.activityExtId == undefined || this.activityExtId == null) && this.taskRecordTypeName == 'TM_Call'){
                ...
                if((this.activityExtId != undefined || this.activityExtId != null) && this.taskRecordTypeName == 'WT_WFG_Call')
                {
                    this.showWFGEditlayout=false; 
                    this.showWFGViewlayout=true; 
                }
               if((this.activityExtId == undefined || this.activityExtId == null) && this.taskRecordTypeName == 'WT_WFG_Call')
               {
                this.showWFGEditlayout=true; 
                this.showWFGViewlayout=false;    
                }
                ...
                if(this.taskRecordTypeName != undefined && this.taskRecordTypeName != null
                    && this.taskRecordTypeName == 'WT_WFG_Call'){
